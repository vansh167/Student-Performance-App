...
export default function Welcome() {
  useEffect(() => {
    ...
    const sample = [
      ...
      { name: "Suhani", score: "74 / 100", cat: "Good", trend: "Up" },
      { name: "Aman Singh", score: "56 / 100", cat: "Average", trend: "Down" },
      { name: "Vansh", score: "42 / 100", cat: "Poor", trend: "Up" },
    ];
    ...
    const leaderboard = [
      [
        ...
        { name: "Taniya", score: 81, trend: "Down" },
      ],
      [
        { name: "Vansh Dhiman", score: 94, trend: "Up" },
        { name: "Rahul Sharma", score: 90, trend: "Down" },
        { name: "Suhani", score: 79, trend: "Down" },
      ],
      [
        { name: "Ritika", score: 95, trend: "Up" },
